...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Crear un párrafo para el gentilicio y la población
  const parrafoData = document.createElement("p");
  parrafoData.textContent = termasDeRioHondo.getInfoSecundaria();

  // Crear un párrafo para la ciudad
  const parrafoData2 = document.createElement("p");
  parrafoData2.textContent = termasDeRioHondo.escribirCoordenadas();
